...
(function() {
  ...
  window.I18N = {
    zh: {
      ...
      aiHubBrand: "地球村商学院 · 全球开源AI工具集",
      aiHubTitle: "🤖 全球前10大开源AI系统 · 免费API工具集",
      aiHubDesc: "集成全球最强大的开源AI系统，为地球村商学院学员提供免费AI工具。支持文本生成、代码编写、图像创作、语音合成、多语言翻译等能力。每个AI系统都有免费额度，无需信用卡即可使用。",
      aiHubSystems: "AI系统",
      aiHubCapabilities: "能力维度",
      aiHubLanguages: "多语言",
      aiHubFree: "免费额度",
      aiSearchPh: "搜索AI工具名称、能力...",
      cat_text: "📝 文本生成",
      cat_code: "💻 代码生成",
      cat_image: "🎨 图像创作",
      cat_voice: "🔊 语音音频",
      ...
      cat_reasoning: "🧠 推理思考",
      aiChatTitle: "💬 AI对话终端",
      aiChatDesc: "选择一个AI系统，直接在下方输入框对话。免费API额度有限，请合理使用。",
      aiSelectProvider: "-- 选择AI系统 --",
      aiApiKeyPh: "输入API Key（免费获取，见各卡片说明）",
      aiChatWelcome: "欢迎使用地球村商学院AI工具集！请选择一个AI系统并输入API Key开始对话。",
      aiChatInputPh: "输入消息...",
      aiSend: "发送",
      aiClear: "清空",
      ...
      aiResultUnit: "个AI工具",
      aiNoResult: "未找到匹配的AI工具，请尝试其他关键词。",
      aiDoc: "📖 文档",
      aiAPI: "🔗 API",
      aiDetail: "📋 详情",
      aiModalProvider: "提供方：",
      ...
      aiChatSelectFirst: "请先选择一个AI系统。",
      aiChatNeedKey: "请输入API Key。请访问文档获取免费API Key。",
      aiChatCleared: "对话已清空。选择一个AI系统开始新的对话。",
      aiChatImgHint: "是图像生成模型。请通过文档直接使用图像生成功能。在对话终端中暂不支持图像生成。",
      aiChatVoiceHint: "是语音识别模型。请通过文档上传音频文件进行转录。在对话终端中暂不支持音频上传。",
      aiChatTryText: "你可以尝试选择文本类AI系统进行对话。",
      aiChatReqFail: "❌ 请求失败：",
      aiChatCheckKey: "请检查API Key是否正确，或访问文档：",
      skillBrand: "地球村商学院 · 30组标准化SKILL",
      skillTitle: "🎯 地球村商学院 30 组标准化 SKILL",
      skillDesc: "适配100门公开课体系，每周自动同步更新。三类技能覆盖地球村商业、星际文明拓展与通用备用赛道。",
      skillCount: "标准化SKILL",
      skillCats: "分类体系",
      skillDist: "技能分布",
      skillIter: "迭代更新",
      skillSearchPh: "🔍 搜索SKILL标识符、名称、关键词...",
      skillCountUnit: "个SKILL",
      skillNoResult: "🔍 未找到匹配的SKILL，请尝试其他关键词",
      skillModalDef: "📝 技能释义",
      skillModalTags: "🏷️ 标签",
      skillTagCore: "🌍 核心课程",
      skillTagCosmic: "🚀 星际文明",
      skillTagBackup: "🔧 备用拓展",
      skillTagStandard: "标准化SKILL",
      skillTagWeekly: "每周更新",
      skillModalIdFormat: "🔗 标识符格式",
      skillModalIdDesc: "小写连字符格式，适配网页检索、学员技能标签筛选、AI课程匹配接口",
