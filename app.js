...
const I18N = {
  zh: {
    ...
    aiToolsCount: "AI系统", aiToolsFree: "免费额度", aiToolsLangs: "语言支持",
    ...
    aiToolsTitle: "🤖 AI 工具集成平台",
    aiToolsDesc: "集成全球前10大开源AI系统的免费额度API，为地球村学员提供智能学习助手。无需付费即可使用DeepSeek、Qwen、Llama、Gemini等顶尖AI模型，辅助课程学习、知识问答、内容创作与多语言翻译。",
    ...
    aiToolsBtnText: "🚀 进入 AI 工具平台", aiToolsNote: "支持文本对话、图像生成、语音转录等多种AI能力",
